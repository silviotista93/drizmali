 ...
 */
define( 'HTTP2_PUSH_CONTENT', '1.6.6' );
...
function pisol_http2_plugin_link( $links ) {
	$links = array_merge( array(
        '<a href="' . esc_url( admin_url( '/admin.php?page=http2-push-content' ) ) . '">' . __( 'Settings' ) . '</a>',
        '<a style="color:#0a9a3e; font-weight:bold;" target="_blank" href="' . esc_url(HTTP2_PUSH_CONTENT_BUY_URL) . '">' . __( 'Buy PRO Version' ) . '</a>'
	), $links );
	return $links;
}
