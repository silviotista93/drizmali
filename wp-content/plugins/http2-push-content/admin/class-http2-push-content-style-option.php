...
class Http2_Push_Content_Style_Option{
    ...
    function tab_content(){
       ...
       ?>
        ...
        <div class="flex">
        <input required type='text' class="form-control w-50 css_identifier" name="http2_async_css_list[{{: count}}][css]" value="{{: value.css}}" placeholder="CSS Identifier">
        ...
        <select required class="form-control w-25"  name="http2_async_css_list[{{: count}}][apply_to]">
            <?php 
