...
class Http2_Push_Content_General_Option{
    ...
    function __construct($plugin_name){
        ...
        $this->settings = array(
                ...
                array('field'=>'push_all_style', 'label'=>__('Push/Preload all style','http2-push-content'),'type'=>'select', 'value'=>array(false =>__('Do Nothing','http2-push-content'), 'push'=>__('Push','http2-push-content'), 'preload'=>__('Preload','http2-push-content'), 'push-preload'=>__('Push Preload','http2-push-content')), 'default'=>'push-preload', 'desc'=>'This push and preload all the style sheet added using enque method'),
                array('field'=>'push_all_script', 'label'=>__('Push/Preload all script','http2-push-content'),'type'=>'select', 'value'=>array(false =>__('Do Nothing','http2-push-content'),'push'=>__('Push','http2-push-content'), 'preload'=>__('Preload','http2-push-content'), 'push-preload'=>__('Push Preload','http2-push-content')), 'default'=>'push-preload', 'desc'=>'This push and preload all the script added using enque method'),
            );
    ...
    function tab_content(){
       ...
       ?>
        ...
        <select required class="form-control w-25"  name="http2_push_general_list[{{: count}}][apply_to]">
            <?php 
        ...
        ?>
        <h2><?php echo __('Push or Preload or Do Both to any content:','http2-push-content'); ?></h2>
