...
class Http2_Push_Content_Js_Option{
    ...
    function tab_content(){
       ...
       ?>
        ...
        <div class="flex">
        <input required type='text' class="form-control w-50 css_identifier" name="http2_async_js_list[{{: count}}][js]" value="{{: value.js}}" placeholder="JS Identifier">
        ...
        <select required  class="form-control w-25" name="http2_async_js_list[{{: count}}][apply_to]">
            <?php 
